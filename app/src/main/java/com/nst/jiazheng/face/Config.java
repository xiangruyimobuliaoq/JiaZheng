...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "bbkcmG1DWe1xlX6301fknrWX";
    public static String secretKey = "4mAHN1aXMD68PwTOXgRMEremDD40LHSs";
    public static String licenseID = "Djjz-face-android";
